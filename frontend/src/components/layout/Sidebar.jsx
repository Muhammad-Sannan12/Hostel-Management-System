    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="absolute top-1/2 -translate-y-1/2 z-50 flex items-center justify-center transition-none"
          style={{
            width: "24px",
            height: "24px",
            borderRadius: "50%",
        ...
        >
          <ChevronRight
            style={{ width: "12px", height: "12px", color: "#0F172A" }}
          />
        </button>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Building2
            style={{ width: "13px", height: "13px", color: "#FFFFFF" }}
          />
        </div>
        <div>
          <div
